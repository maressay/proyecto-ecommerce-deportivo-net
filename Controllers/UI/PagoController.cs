...
namespace proyecto_ecommerce_deportivo_net.Controllers.UI
{
    ...
    public class PagoController : Controller
    {
        ...
        public PagoController(ILogger<PagoController> logger, UserManager<ApplicationUser> userManager, ApplicationDbContext context, IMyEmailSender emailSender)
        {
            _logger = logger;
        ...
        private string ConstruirTexto(Pedido pedido, ApplicationUser cliente, List<DetallePedido2> detalles)
        {
            ...
            texto.AppendLine("|            AthletiX                 |"); // Nombre de la empresa
            ...
            texto.AppendLine($"| Cliente: {cliente.Nombres} {cliente.Apellidos} |"); // Nombre del Cliente
            ...
            texto.AppendLine();
            texto.AppendLine("[La Empresa Deportiva AthletiX]");
            texto.AppendLine();
